...
/*
 * Game checks
 * The class is stateless (all methods are static), so you can call it as you want from where you want
 */
public class staticGameAshtonTablut {
	
	protected static List<String> citadels = GameAshtonTablut.citadels;
	
	public static boolean checkAction(State state, Action a, boolean DEBUG) {
	...
	protected static State checkCaptureWhite(State state, Action a) {
		...
		if (a.getColumnTo() < state.getBoard().length - 2
			...
			state.setMovesWithutCapturing(-1);
		...
		state.setMovesWithutCapturing(state.getMovesWithutCapturing()+1);
		return state;
	}
	...
	protected static State checkCaptureBlack(State state, Action a) {
